...
HX711_SHELF_SCALE = 10.78             # Shelf: raw units per gram (calibrated 2026-03-30 with 2kg)
HX711_MIX_SCALE = 17.86              # Mixing: raw units per gram (calibrated 2026-03-30 with 2kg)
